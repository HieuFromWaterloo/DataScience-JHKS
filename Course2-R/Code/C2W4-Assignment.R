...
# Finding the best hospital in a state: SOLN #1
best <- function(state, outcome) {
  
  # Read outcome data
  out_dt <- data.table::fread('C:/Users/Hieu Ng/Desktop/DS-JHK/Course2-R/Code/Assignment3-data/outcome-of-care-measures.csv')
...
best <- function(state, outcome) {
  ...
  ## Read outcome data
  data <- read.csv("C:/Users/Hieu Ng/Desktop/DS-JHK/Course2-R/Code/Assignment3-data/outcome-of-care-measures.csv", colClasses = "character")
...
###### RANKING HOSPITAL BY OUTCOME ###### SOLUTION #1
